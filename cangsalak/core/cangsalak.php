...
class Cangsalak
{
    ...
    function connection()
    {
        ...
        $create = fopen($con, "w") or die("เปลี่ยนโฟลเดอร์อนุญาตสำหรับแอปพลิเคชันและโฟลเดอร์ cangsalak เป็น 777");
        ...
        {
            echo $this->sql->connect_error . ", โปรดตรวจสอบ 'application/config/database.php'.";
            die();
        }
