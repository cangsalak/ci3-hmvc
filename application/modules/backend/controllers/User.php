...
class User extends Backend
{
  ...
  function _rules()
  {
    ...
    $this->form_validation->set_rules('agency', 'agency', 'trim|xss_clean');
  ...
  function update($id)
  {
    ...
    if ($row = $this->model->get_where_data(dec_url($id))) {
      ...
      $data = array(
        ...
        'agency' => set_value("agency", $row->agency),
  ...
  function update_action($id)
  {
    if ($this->input->is_ajax_request()) {
      ...
      if ($this->form_validation->run()) {
        ...
        $update['agency'] = $this->input->post('agency');
