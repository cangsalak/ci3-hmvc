...
/**
	 ...
	 * สาขา อโศก
*/
/* Location: ./application/modules/backend/models/Position_model.php*/
...
//*******************************************************ชื่อฐานข้อมูล*******************************************************\\
  ...
  private $column_order = ["po_id","po_num","po_name"];
  private $order = ["po_id"=>"DESC"];
  private $select = "po_id,po_id,po_num,po_name";
  ...
  private function _get_datatables_query()
  {
    ...
    //filter
			if($this->input->post('po_id')){
				$this->db->like('po_id', $this->input->post('po_id'));
			}
			if($this->input->post('po_num')){
				$this->db->like('po_num', $this->input->post('po_num'));
			}
			if($this->input->post('po_name')){
				$this->db->like('po_name', $this->input->post('po_name'));
			}
