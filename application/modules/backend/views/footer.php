...
<footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Page rendered in
            <strong>{elapsed_time}</strong> seconds.<?=$this->config->item("author") ?> -
            <?=$this->config->item("version") ?> Copyright © <?=date("Y")?>. All rights reserved.</span>
        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">สร้างด้วยมือ & ทำด้วย <i
...
<!-- js -->
<script type="text/javascript" src="<?=base_url()?>_temp/backend/bootstrap-datepicker-thai/js/bootstrap-datepicker.js">
</script>
<script type="text/javascript"
    src="<?=base_url()?>_temp/backend/bootstrap-datepicker-thai/js/bootstrap-datepicker-thai.js"></script>
<script type="text/javascript"
    src="<?=base_url()?>_temp/backend/bootstrap-datepicker-thai/js/locales/bootstrap-datepicker.th.js"></script>
            ...
            callbacks: {
                ...
                onInit: function() {
                    $(document).on("click", "button[data-original-title='Picture']", function(e) {
                        ...
                        $(".modal[aria-label='Insert Image'] .modal-body").append(
                            '<p id="filemanager-note"><a class="btn btn-sm btn-warning" target="_blank" href="' +
                            BASE_URL + 'backend/filemanager">Open Filemanager</a></p>');
                    });

                    $(document).on("click", ".btn-fullscreen", function(e) {
                        e.preventDefault();
                        var isFullscreen = $('.text-editor').summernote(
