<div class="row">
  <div class="col-md-12 col-xl-12 mx-auto animated <?=setting("animation")?>  delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-1">
          <a href="<?=url("affiliation/add")?>" id="add" class="btn btn-sm btn-success btn-icon-text">
          ...
          <a href="<?=url("affiliation/filter/")?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover" id="table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            <thead class="thead-light">
              <tr>
								<th><?= cclang('Af Sname')?></th>
								<th><?= cclang('Af Fname')?></th>
								<th><?= cclang('Af Social')?></th>
								<th><?= cclang('Af Tel')?></th>
                <th><?=cclang("action")?></th>
              </tr>
            </thead>
