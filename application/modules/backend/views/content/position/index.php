<div class="row">
  <div class="col-md-12 col-xl-12 mx-auto animated <?=setting("animation")?>  delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-1">
          <a href="<?=url("position/add")?>" id="add" class="btn btn-sm btn-success btn-icon-text">
          ...
          <a href="<?=url("position/filter/")?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text">
