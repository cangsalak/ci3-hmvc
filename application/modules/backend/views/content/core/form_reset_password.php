<form id="form" action="<?=site_url("backend/core/reset_password_action")?>">
  ...
  <div class="form-group row">
      <label class="col-sm-4 col-form-label"><?=cclang("New_Password")?></label>
      <div class="col-sm-8">
  ...
  <div class="form-group row">
      <label class="col-sm-4 col-form-label"><?=cclang("Confirm_Password")?></label>
      <div class="col-sm-8">
  ...
  <div class="text-right">
    ...
    <button type="submit" id="submit" name="submit" class="btn btn-sm btn-primary"><?=cclang("Reset_Password")?></button>
  </div>
</form>
