    ...
    <div class="qq-new-skin shadow qq-upload-image-placeholder  qq-uploader-selector qq-uploader qq-gallery " qq-drop-area-text="Drop files here">
      ...
      <div class="qq-upload-drop-area-selector qq-upload-drop-area" qq-hide-dropzone>
       ...
       <div class="qq-upload-button-selector qq-upload-button">
        <div><?=cclang("Upload")?></div>
      </div>

      <span class="qq-drop-processing-selector qq-drop-processing">
        <span><?=cclang("Processing_dropped_files")?></span>
      ...
      <dialog class="qq-alert-dialog-selector">
        ...
        <div class="qq-dialog-buttons">
          <button type="button" class="qq-cancel-button-selector"><?=cclang("Close")?></button>
        </div>
      </dialog>
      ...
      <dialog class="qq-confirm-dialog-selector">
        <div class="qq-dialog-message-selector"></div>
        <div class="qq-dialog-buttons">
          <button type="button" class="qq-cancel-button-selector"><?=cclang("No")?></button>
          <button type="button" class="qq-ok-button-selector"><?=cclang("Yes")?></button>
        </div>
      </dialog>
      ...
      <dialog class="qq-prompt-dialog-selector">
        ...
        <input type="text">
        <div class="qq-dialog-buttons">
          <button type="button" class="qq-cancel-button-selector"><?=cclang("Cancel")?></button>
          <button type="button" class="qq-ok-button-selector"><?=cclang("Ok")?></button>
        </div>
      </dialog>
    </div>
  </script>
