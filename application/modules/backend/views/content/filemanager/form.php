      ...
      <div class="card-body">
        <form id="form" action="<?=$action?>" autocomplete="off">
							...
							<div class="input-group col-xs-12">
								...
								<input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="filemanager" readonly name="file_name" value="<?=$file_name?>" />
									<span class="input-group-append">
										...
										<button class="file-upload-browse btn btn-primary btn-sm" data-id="filemanager" type="button"><?=cclang("Select_File")?></button>
									</span>
							</div>
          ...
          <div class="form-group">
            ...
            <textarea name="ket" id="ket" class="form-control" rows="2" cols="80"><?=cclang("module_File_manager")?></textarea>
          </div>
