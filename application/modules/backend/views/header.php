...
<head>
  ...
  <title><?=ucwords($title_module).' - '.setting("web_name")?></title>
...
<link href="<?=base_url()?>_temp/backend/bootstrap-datepicker-thai/css/datepicker.css" rel="stylesheet">

<!-- theme colors -->
<link href="<?=base_url()?>_temp/backend/themes/<?=setting("theme_color")?>.css" rel="stylesheet">
