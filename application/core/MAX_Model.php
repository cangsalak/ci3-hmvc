...
//abstract Class MAX_Model extends CI_Model
Class MAX_Model extends CI_Model
{
    ...
    /*      - Example:: MAX_Model::get_instance()->get_row(...)
    /*/////////////////////////////////////////*/
    /** Get Db object instance (Singleton) */
    public static function get_instance()
    {
        if (!isset(self::$_instance))
            self::$_instance = new MAX_Model();
    ...
    function intro($id=NULL){
        ...
        foreach(get_class_vars(get_class($this)) as $field => $val) {
            if(!in_array($field,array_keys(get_class_vars('MAX_Model')))) {
